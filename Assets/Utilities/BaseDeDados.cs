...
public class BaseDeDados {
    ...
    public  void StartBase()
    {
        ...
        temp.texto[0].escolha.escolhas = new string[5] { "parlavra", "palavra", "parlávra", "palava", "colhoro" };
        temp.texto[0].escolha.corretas = new bool[5] { false, true, false, false, false };
        temp.texto[0].escolha.respostas = new string[5] { "erooowwww", "aEHOUUU", "nun", "%$¨@& brother", "nunca" };
